...
// ─── Generated typed structs ──────────────────────────────────────────────────

pub struct Draft07ValidationSpecAsJSONSchema {
    // JSON key: "type"
    ...
    // JSON key: "exclusiveMaximum"
    pub exclusive_maximum: Option<f64>,
    pub minimum: Option<f64>,
    // JSON key: "exclusiveMinimum"
    ...
    // JSON key: "if"
    pub r#if: Option<Value>,
    // JSON key: "then"
    pub r#then: Option<Value>,
    // JSON key: "else"
    ...
    // JSON key: "contentMediaType"
    pub content_media_type: Option<String>,
    // JSON key: "contentEncoding"
